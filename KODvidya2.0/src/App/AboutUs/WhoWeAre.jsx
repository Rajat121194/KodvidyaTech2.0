...
const WhoWeAre = () => {
  return (
    <section className="relative bg-kalu text-chitu py-25 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-kalu/40"></div>

      {/* Content */}
      <div className="relative z-10 text-center mb-4 py-10">
      ...
      <div className="relative z-10 w-full md:w-3/4 lg:w-1/2 md:self-end text-center md:text-left mx-auto">
        <h2 className="text-5xl text-chitu font-Sans mb-2">Hey Everyone!</h2>
        <p className="text-2xl text-chitu font-Sans">
