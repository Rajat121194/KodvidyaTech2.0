    ...
    <div className="bg-white px-6 py-3 md:py-12 md:px-16 lg:px-24">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div className="order-2 md:order-1">
          <h2 className="text-3xl md:text-6xl font-Bebas text-gold mb-1">
          ...
          <ul className="space-y-2">
            {benefits.map((benefit, idx) => (
              <li key={idx} className="flex items-start text-blue space-x-3">
                <GiBarbedSun className="text-gold mt-1" />
                <span>{benefit}</span>
              </li>
            ))}
          </ul>
