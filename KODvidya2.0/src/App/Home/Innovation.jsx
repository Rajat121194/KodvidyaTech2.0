...
const BusinessSuccess = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="flex flex-col md:flex-row items-center justify-center p-8 md:p-16 gap-20"
    >
      <div className="flex-2">
        ...
        <p ref={paraRef} className="text-blue text-xl mb-6 font-Sans">
          ...
          convert your dream project into reality. At CodeMechanism Infotech, We
          focus to work on the best possible solution to speed up your solution
          without doing any compromise to deliver quality work. With the help of
          our experienced software developers we are always ready to kickstart
          any kind of requirements and deliver the work as per timeline.
        </p>
