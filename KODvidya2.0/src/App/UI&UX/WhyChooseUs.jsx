...
const services = [
  {
    ...
    icon: <FaMousePointer className="text-4xl text-blue" />,
  ...
  },
  {
    ...
    icon: <FaPalette className="text-4xl text-gold" />,
  ...
  },
  {
    ...
    icon: <AiOutlineFundProjectionScreen className="text-4xl text-blue" />,
    hoverBg: "hover:bg-gold",
  },
  {
    ...
    icon: <MdScreenSearchDesktop className="text-4xl text-gold" />,
    hoverBg: "hover:bg-blue",
  },
  {
    ...
    icon: <BiLayer className="text-4xl text-blue" />,
    hoverBg: "hover:bg-gold",
  },
  {
    ...
    icon: <FaMobileAlt className="text-4xl text-gold" />,
    hoverBg: "hover:bg-blue",
  },
];
